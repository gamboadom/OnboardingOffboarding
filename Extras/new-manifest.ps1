...
$Params = @{
    'Path' = 'OnboardingOffboarding.psd1' # Path to the module manifest file
    'Author' = 'Dom Gamboa'
   ...
   'RequiredModules' = @('ActiveDirectory', 'ExchangeOnlineManagement', 'Microsoft.Graph', 'Microsoft.Graph.Authentication')
